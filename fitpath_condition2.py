...
<div class="hero">
    ...
    <div class="hero-subtitle">
        A personalized fitness planning assistant with privacy coaching from FitPath.
    </div>
</div>
""",
    unsafe_allow_html=True,
...
FitPath also provides privacy support during onboarding.
...
Please enter your Prolific ID to begin.
    ...
    if st.button("Start", use_container_width=True):
        ...
        save_message(
            participant_id=pid,
            role="system",
            content="Participant started Condition 2.",
            turn_index=0,
...
if st.session_state.stage == "summary_choice":
    ...
    with col2:
        summary_html = (
            ...
            "<div class='summary-caption'>More generalized version prepared by FitPath.</div>"
...
if user_input:
    ...
    if st.session_state.stage == "onboarding":
        ...
        with st.chat_message("assistant", avatar=FITPATH_AVATAR):
            with st.spinner("FitPath is reviewing your answer..."):
        ...
        append_message(
            role="assistant",
            content="FitPath privacy review",
            agent="FitPath",
